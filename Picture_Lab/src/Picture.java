...
public class Picture extends SimplePicture 
{
  ...
  public void fixUnderwater()
  {
    for(Pixel[] rowArray: this.getPixels2D()) {
      for(Pixel pixelObj: rowArray) {
        pixelObj.setRed(Pixel.correctValue(pixelObj.getRed()+100));
        //pixelObj.setGreen(Pixel.correctValue(pixelObj.getGreen()));
        //pixelObj.setBlue(Pixel.correctValue(pixelObj.getBlue()));
      }
    }
  }
